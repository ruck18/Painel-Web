...
.alert.success {background-color: #7367f0;}
.alert.info {background-color: #7367f0;}
.alert.warning {background-color: #7367f0;}
...
<div class="alert">
  ...
  <strong>🚨</strong> CONTA ADMIN É SÓ PARA ADMINISTRAÇÃO, FAÇA UMA CONTA REVENDA PARA GERENCIAR SEUS CLIENTES.
</div>
