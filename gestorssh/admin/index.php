...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
    ...
    <div class="app-content content ">
        ...
        <video autoplay muted loop>
            <source src="../app-assets/images/avatars/fundo1.mp4" type="video/mp4">
        </video>
    </div>
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-1">
                                            <label class="form-label" for="first-name-icon">Usuario</label>
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" class="form-control" id="login" name="login" placeholder="usuario de acesso" required />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <button type="button" class="btn btn-primary w-100" name="mybtn" id="mybtn" tabindex="4">LOGAR COM ADMIN</button>
                                    </div>
                                </div>
                                ...
                                <div class="auth-footer-btn d-flex justify-content-center">
                                    <button type="button" id="mybtn" class="btn btn-primary w-100 animate__animated animate__zoomIn" tabindex="4"><a class="text-primary text-center" href="/"><font color="#ffffff">LOGAR COMO REVENDA</a>
                                </div>
                            </div>
                        </div>
                        <!-- /Login basic -->
