...
?>
    ...
    <div class="col-lg-3 col-sm-6 col-12">
      <div class="card border-<?php echo $bg; ?>">
        <a href="baixar.php?id=<?php echo $row['id']; ?>">
          <div class="card-header d-flex flex-column align-items-center pb-0">
            ...
            <?php } ?>
			<h4 class="text-bold-700 mt-1 text-success"><?php echo $dia;?>/<?php echo $mes;?>/<?php echo $ano;?></h4>
			<h4 class="text-bold-700 mt-1 text-warning"><?php echo $row['detalhes'];?></h4>
            <p class="mb-2"></p>
          </div>
        </a>
      </div>
