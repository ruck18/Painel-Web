...
CREATE TABLE `arquivo_download` (
  ...
  `operadora` enum('todas','1cla','2vi','3ti','4oi') COLLATE utf8mb4_unicode_ci NOT NULL,
...
(20, 1, '📱 4Ot 5G 08 📡 💛', 'oi', 'GET / HTTP/1.3[crlf]Host: [host][crlf]Upgrade: websocket[crlf][crlf]', 'oii.gdmhost.ga', '104.16.56.6', '104.16.56.6', '', 'Tlsws');
